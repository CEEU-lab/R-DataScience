...
La función apply y sus variantes sirven to manipulate slices of data in the form of matrices, arrays, lists or dataframes in a repetitive way, allowing to cross or traverse the data and avoiding explicit use of loop constructs. 

The functions act on an input matrix or array and apply a chosen named function with one or several optional arguments.


### 1. apply()
You want to apply a given function to the rows (index “1”) or columns (index “2”) of a matrix or dataframe. 
